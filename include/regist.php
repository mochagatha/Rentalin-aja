...
<script type="text/javascript">
	...
	$("#loaderIcon").show();
	jQuery.ajax({
		url: "index.php?include=check-availability",
  ...
  <div class="container">
      <div class="user_profile_info">
		...
		<div class="col-md-12 col-sm-10">
              <form  method="post" name="theform" action="index.php?include=regist-act" id="theform" onSubmit="return checkLetter(this);" enctype="multipart/form-data">
                ...
                <div class="form-group">
					Upload Foto Profil<span style="color:red">*</span><input type="file" name="img2" accept="image/*" required>
				</div>
                <div class="form-group">
