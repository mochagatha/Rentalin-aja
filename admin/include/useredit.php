...
<head>
	...
	<title>RentalinAja | Admin Edit Data User</title>
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										?>
										<form method="post" class="form-horizontal" name="theform" action ="index.php?include=user-edit-act" onsubmit="return valid(this);" enctype="multipart/form-data">
