...
<head>
	...
	<title>RentalinAja | Admin Laporan</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
						...
						<div class="panel panel-default">
							...
							<div class="form-group">
									<a href="index.php?include=laporan-cetak&awal=<?php echo $mulai;?>&akhir=<?php echo $selesai;?>" target="_blank" class="btn btn-primary">Cetak</a>
							</div>
						<?php }?>
