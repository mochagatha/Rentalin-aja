...
<head>
	...
	<title>RentalinAja | Admin Edit Merek</title>
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<form method="post" name="theform" class="form-horizontal" action="index.php?include=merek-edit-act" onSubmit="return valid(this);">	
									<?php
									$id=$_GET['id'];
