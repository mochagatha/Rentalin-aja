...
<head>
	...
	<title>RentalinAja | Admin Edit Info Mobil</title>
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<form method="post" class="form-horizontal" name="theform" action ="index.php?include=mobil-edit-act" onsubmit="return valid(this);" enctype="multipart/form-data">
										...
										<div class="form-group">
											<div class="col-sm-4">
												...
												<a href="index.php?include=change-image1&imgid=<?php echo htmlentities($result['id_mobil'])?>">Ganti Gambar 1</a>
											</div>
											<div class="col-sm-4">
												Gambar 2<img src="img/vehicleimages/<?php echo htmlentities($result['image2']);?>" width="300" height="200" style="border:solid 1px #000">
												<a href="index.php?include=change-image2&imgid=<?php echo htmlentities($result['id_mobil'])?>">Ganti Gambar 2</a>
											</div>
											<div class="col-sm-4">
												Gambar 3<img src="img/vehicleimages/<?php echo htmlentities($result['image3']);?>" width="300" height="200" style="border:solid 1px #000">
												<a href="index.php?include=change-image3&imgid=<?php echo htmlentities($result['id_mobil'])?>">Ganti Gambar 3</a>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-sm-4">
												...
												<a href="index.php?include=change-image4&imgid=<?php echo htmlentities($result['id_mobil'])?>">Ganti Gambar 4</a>
											</div>
											<div class="col-sm-4">
												Gambar 5
												<?php if($result['image5']=="")
												{
													...
													<a href="index.php?include=change-image5&imgid=<?php echo htmlentities($result['id_mobil'])?>">Ganti Gambar 5</a>
												<?php } ?>
											</div>
										</div>
