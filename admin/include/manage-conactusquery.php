...
<head>
	...
	<title>RentalinAja | Admin Manage Queries   </title>
...
{	$no++;
	?>	
										<tr>
											...
											<td><a href="index.php?include=manage-conact-us-query&eid=<?php echo htmlentities($result['id_cu']);?>" onclick="return confirm('Tandai sudah dibaca?')" >Baca</a></td>
											<?php } ?>
										</tr>
								<?php } ?>		
									</tbody>
