...
<head>
	...
	<link href="../assets/images/logo.png" rel="icon" type="images/x-icon">
		...
		<div class="container-fluid">
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td class="text-center"><h2>RentalinAja</h2></td>
					</tr>
					<tr>
						<td class="text-center">JALAN SIGURA-GURA VI No.25, Kel. SUMBERSARI, Kec.LOWOKWARU, KOTA MALANG</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
