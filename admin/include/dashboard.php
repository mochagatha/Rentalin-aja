...
<head>
	...
	<title>RentalinAja | Admin Dashboard</title>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="index.php?include=sewa-bayar" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="index.php?include=sewa-konfirmasi" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="index.php?include=sewa-kembali" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="index.php?include=merek" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="index.php?include=mobil" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="index.php?include=sewa" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="index.php?include=reg-users" class="block-anchor panel-footer text-center">Rincian <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="index.php?include=manage-conact-us-query" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
