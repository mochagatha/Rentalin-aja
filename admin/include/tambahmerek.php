...
<head>
	...
	<title>RentalinAja | Admin Create Brand</title>
							...
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form id="theform" name="theform" method="post" class="form-horizontal" action="index.php?include=merek-act" onSubmit="return valid(this);">
