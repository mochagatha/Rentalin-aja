...
<head>
	...
	<title>RentalinAja | Admin Kelola Sewa   </title>
...
<body>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										...
										<tr align="center">
											...
											<a href="index.php?include=sewa-edit-kembali&id=<?php echo $result['kode_booking'];?>"><i class="fa fa-edit"></i></a></td>
										</tr>
										<?php }?>
									</tbody>
								</table>
	...
	<script>
		...
		$('[data-load-code]').on('click',function(e) {
					...
					if(code) {
						$($this.data('remote-target')).load('index.php?include=sewa-view&code='+code);
						app.code = code;
