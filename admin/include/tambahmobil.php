...
<head>
	...
	<title>RentalinAja | Admin Tambah Mobil</title>
	<!-- Font awesome -->
						...
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<form method="post" name="theform" action="index.php?include=tambah-mobil-act" class="form-horizontal" onsubmit="return valid(this);" enctype="multipart/form-data">
