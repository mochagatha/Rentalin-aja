...
<head>
	...
	<title>RentalinAja | Admin Kelola User</title>
...
<body>
									...
									?>	
										<tr>
											...
											<td>
												...
												<a href="index.php?include=user-del&email=<?php echo $result['email'];?>" onclick="return confirm('Apakah anda yakin akan mereset password untuk email <?php echo $result['email'];?>?');"><i class="fa fa-refresh"></i></a>
											</td>
										</tr>
										<?php } ?>
    ...
    <script>
		...
		$('[data-load-code]').on('click',function(e) {
					...
					if(code) {
						$($this.data('remote-target')).load('index.php?include=user-view&code='+code);
						app.code = code;
