...
<head>
	...
	<title>RentalinAja | Admin Kelola Mobil</title>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										<tr>
											...
											<th>Type BB</th>
											<th>Tahun</th>
											<th><a href="index.php?include=tambah-mobil"><span class="fa fa-plus-circle"></span>Tambah Mobil</a></th>
										</tr>
									</thead>
									<tbody>
									<?php 
										...
										<tr>
											...
											<td class="text-center"><a href="index.php?include=mobil-edit&id=<?php echo $result['id_mobil'];?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
												<a href="index.php?include=mobil-del&id=<?php echo $result['id_mobil'];?>" onclick="return confirm('Apakah anda akan menghapus <?php echo $result['nama_mobil'];?>?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
