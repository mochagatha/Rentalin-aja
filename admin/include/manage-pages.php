...
<head>
	...
	<title>RentalinAja | Admin Kelola Halaman</title>
									...
									<div class="panel-body">
										...
										<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Pilih Pembayaran</label>
												<div class="col-sm-4">
													<select name="menu1" class="form-control" onChange="MM_jumpMenu('parent',this,0)">
													  <option value="" selected="selected" class="form-control">***Pilih Pembayaran***</option>
													  <option value="index.php?include=manage-pages&type=rekening">Rekening</option>
													</select>
												</div>
											</div>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Pembayaran Terpilih</label>
												<div class="col-sm-4">
												<?php
												switch($_GET['type'])
												{
